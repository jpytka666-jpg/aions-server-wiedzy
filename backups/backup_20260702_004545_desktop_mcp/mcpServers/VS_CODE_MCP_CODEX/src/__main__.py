...
# Refuse wrong Python — Cursor sometimes spawns system Python311 without Playwright
_venv_scripts = (Path(__file__).resolve().parents[3] / "venv" / "Scripts").resolve()
if _venv_scripts not in Path(sys.executable).resolve().parents:
    print(
